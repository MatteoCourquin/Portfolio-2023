    ...
    <div class="header-btns-container">
      <div class="container-burger">
        ...
        <div class="container-burger-circle">
          <img preload src="/images/logos/burger-circle.svg" quality="10" ref="burgerCircle" class="burger-circle"
            alt="" />
          <svg class="progress-bar" id="Calque_1" data-name="Calque 1" xmlns="http://www.w3.org/2000/svg" width="220"
            height="220" viewBox="0 0 220 220">
