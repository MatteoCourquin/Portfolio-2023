    ...
    <section ref="sectionCareer" class="section career">
      <div class="slider-section">
        <div ref="sliderContainer" class="slider-container" :style="slider">
          <div v-for="careerItem in careerItems" class="anim-career card-career" :key="careerItem.id" ref="sliderCard">
      ...
      <div class="wrapper-arrow-slider">
        <img @click="slideLeft()" class="arrow-slider arrow-slider_left" src="/images/logos/arrow-slider.svg" />
        <img @click="slideRight()" class="arrow-slider arrow-slider_right" src="/images/logos/arrow-slider.svg" />
      </div>
    </section>
  </div>
</template>
